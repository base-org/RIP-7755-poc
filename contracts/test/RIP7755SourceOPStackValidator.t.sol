...
contract RIP7755OutboxOPStackValidatorTest is Test {
    ...
    RIP7755OutboxOPStackValidator sourceContract;
    ERC20Mock mockErc20;
    ...
    function setUp() external {
        DeployRIP7755OutboxBaseValidator deployer = new DeployRIP7755OutboxBaseValidator();
    ...
    function test_validate_reverts_ifFinalityDelaySecondsInProgress() external fundAlice(_REWARD_AMOUNT) {
        ...
        vm.prank(FILLER);
        vm.expectRevert(RIP7755OutboxOPStackValidator.FinalityDelaySecondsInProgress.selector);
    ...
    function test_validate_reverts_ifBeaconRootCallFails() external fundAlice(_REWARD_AMOUNT) {
        ...
        RIP7755Inbox.FulfillmentInfo memory fillInfo = _initFulfillmentInfo();
        RIP7755OutboxOPStackValidator.RIP7755Proof memory proofData = _buildProof(validProof);
    ...
    function test_validate_reverts_ifInvalidL1Storage() external fundAlice(_REWARD_AMOUNT) {
        ...
        vm.prank(FILLER);
        vm.expectRevert(RIP7755OutboxOPStackValidator.InvalidL1Storage.selector);
        sourceContract.claimReward(request, fillInfo, storageProofData, FILLER);
    }
    ...
    function test_validate_reverts_ifInvalidL2StateRoot() external fundAlice(_REWARD_AMOUNT) {
        ...
        vm.prank(FILLER);
        vm.expectRevert(RIP7755OutboxOPStackValidator.InvalidL2StateRoot.selector);
        sourceContract.claimReward(request, fillInfo, storageProofData, FILLER);
    }
    ...
    function test_validate_reverts_ifInvalidL2Storage() external fundAlice(_REWARD_AMOUNT) {
        ...
        vm.prank(FILLER);
        vm.expectRevert(RIP7755OutboxOPStackValidator.InvalidL2Storage.selector);
        sourceContract.claimReward(request, fillInfo, storageProofData, FILLER);
    }
    ...
    function _buildProofAndEncodeProof(string memory json) private pure returns (bytes memory) {
        RIP7755OutboxOPStackValidator.RIP7755Proof memory proofData = _buildProof(json);
        return abi.encode(proofData);
    }

    function _buildProof(string memory json) private pure returns (RIP7755OutboxOPStackValidator.RIP7755Proof memory) {
        ...
        return RIP7755OutboxOPStackValidator.RIP7755Proof({
